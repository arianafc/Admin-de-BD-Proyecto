        ...
        <div class="modal" id="myModal">
            <article class="modal-container">
                ...
                <section class="modal-container-body rtf">
                    <form action="generarReserva" id="formReserva" class="form">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Instalación"  id="fechaInicioReservaCabana" aria-label="Fecha Inicio"
                                aria-describedby="basic-addon1">
                        </div>
                        <div class="input-group mb-3">
                            <span class="input-group-text" id="basic-addon1">Fecha Fin</span>
                            <input type="text" class="form-control" placeholder="Instalación" id="fechaFinReservaCabana" aria-label="Fecha Fin"
                                aria-describedby="basic-addon1">
                        </div>
                        <div class="input-group mb-3">
                            <span class="input-group-text" id="basic-addon1">Cantidad de Personas</span>
                            <input type="number" class="form-control" placeholder="Cantidad de Personas"  id="personasReservaCabana" aria-label="Instalación"
                                aria-describedby="basic-addon1">
                        </div>
                    </form>
                </section>
                <footer class="modal-container-footer">
                    ...
                    <button class="button is-primary" id="guardarReservaCabana">Reservar</button>
                </footer>
            </article>
        </div>
        <?php incluir_footer() ?>
