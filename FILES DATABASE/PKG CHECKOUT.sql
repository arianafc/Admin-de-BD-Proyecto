...
PROCEDURE FIDE_CHECKOUT_TB_EJECUTAR_SP(P_CARRITO IN NUMBER, P_CEDULA IN NUMBER);
...
BEGIN
    ...
    INSERT INTO FIDE_ORDENES_TB (CEDULA, V_TOTAL, ID_ESTADO, ID_METODO_PAGO) VALUES (P_CEDULA, V_TOTAL, 6, P_METODO_PAGO);
    V_NUMBER := ID_ORDEN_SEQ.CURRVAL;
    FOR CUR IN (SELECT ID_RESERVA, ID_TIPO_MEMBRESIA, CANTIDAD, PRECIO FROM FIDE_CARRITO_ITEMS 
