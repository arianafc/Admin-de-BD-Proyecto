CREATE OR REPLACE PACKAGE FIDE_LOS_JAULES_PROVEEDORES_PKG AS
  ...
  -- Productos
  PROCEDURE FIDE_PRODUCTOS_TB_GET_ALL_SP(p_cursor OUT SYS_REFCURSOR);
  PROCEDURE FIDE_PRODUCTOS_TB_INSERTAR_SP(p_nombre IN VARCHAR2, p_costo IN NUMBER);
  PROCEDURE FIDE_PRODUCTOS_TB_MODIFICAR_SP(p_id IN NUMBER, p_nombre IN VARCHAR2, p_costo IN NUMBER);
  PROCEDURE FIDE_PRODUCTOS_TB_ELIMINAR_SP(p_id IN NUMBER);

  -- Relación productos-proveedor
  PROCEDURE FIDE_PROD_PROVEEDOR_TB_GET_POR_PROVEEDOR_SP(p_cursor OUT SYS_REFCURSOR, p_id_proveedor IN NUMBER);
  PROCEDURE FIDE_PROD_PROVEEDOR_TB_INSERTAR_SP(p_id_proveedor IN NUMBER, p_id_producto IN NUMBER);
  PROCEDURE FIDE_PROD_PROVEEDOR_TB_ELIMINAR_SP(p_id_prod_proveedor IN NUMBER);
...
CREATE OR REPLACE PACKAGE BODY FIDE_LOS_JAULES_PROVEEDORES_PKG AS
  ...
  PROCEDURE FIDE_PRODUCTOS_TB_GET_ALL_SP(p_cursor OUT SYS_REFCURSOR) IS
  BEGIN
    OPEN p_cursor FOR
  ...
  PROCEDURE FIDE_PRODUCTOS_TB_INSERTAR_SP(p_nombre IN VARCHAR2, p_costo IN NUMBER) IS
  BEGIN
  ...
  PROCEDURE FIDE_PRODUCTOS_TB_MODIFICAR_SP(p_id IN NUMBER, p_nombre IN VARCHAR2, p_costo IN NUMBER) IS
  BEGIN
  ...
  PROCEDURE FIDE_PRODUCTOS_TB_ELIMINAR_SP(p_id IN NUMBER) IS
  BEGIN
    UPDATE FIDE_PRODUCTOS_TB
    SET ID_ESTADO = 0
    WHERE ID_PRODUCTO = p_id;
  ...
  PROCEDURE FIDE_PROD_PROVEEDOR_TB_GET_POR_PROVEEDOR_SP(p_cursor OUT SYS_REFCURSOR, p_id_proveedor IN NUMBER) IS
  BEGIN
    OPEN p_cursor FOR
  ...
  PROCEDURE FIDE_PROD_PROVEEDOR_TB_INSERTAR_SP(p_id_proveedor IN NUMBER, p_id_producto IN NUMBER) IS
  BEGIN
  ...
  PROCEDURE FIDE_PROD_PROVEEDOR_TB_ELIMINAR_SP(p_id_prod_proveedor IN NUMBER) IS
  BEGIN
