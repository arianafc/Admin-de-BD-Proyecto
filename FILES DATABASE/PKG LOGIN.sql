...
FUNCTION FIDE_LOS_JAULES_LOGIN_SP(P_CEDULA IN VARCHAR2, P_CONTRASENA IN VARCHAR2) RETURN BOOLEAN;
...
CREATE OR REPLACE PACKAGE BODY FIDE_LOS_JAULES_LOGIN_PKG AS
    ...
    BEGIN
        ...
        BEGIN
            ...
            FROM FIDE_USUARIOS_TB
            WHERE CEDULA = TO_NUMBER (P_CEDULA) ;
        EXCEPTION
            WHEN NO_DATA_FOUND THEN
...
DECLARE
    V_RESULTADO BOOLEAN;
BEGIN
    V_RESULTADO := FIDE_LOS_JAULES_LOGIN_PKG.FIDE_LOS_JAULES_LOGIN_SP('123456789', '123456789');
