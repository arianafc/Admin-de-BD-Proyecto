...
ALTER TABLE FIDE_USUARIOS_TB ADD USUARIO VARCHAR2(20);
...
CREATE OR REPLACE PACKAGE BODY FIDE_LOS_JAULES_LOGIN_PKG AS
    ...
    EXCEPTION
        ...
        WHEN OTHERS THEN
            RAISE_APPLICATION_ERROR(-20002, 'Error al obtener el usuario: ' || SQLERRM);
    END FIDE_LOS_JAULES_GET_USUARIOS_SP;
    ...
    AS
        ...
        V_CEDULA NUMBER;
    BEGIN
        -- Verificar si el usuario existe y obtener la cédula y la contraseña encriptada
        BEGIN
