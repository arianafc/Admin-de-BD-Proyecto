...
CREATE TABLE FIDE_MEMBRESIAS_TB (
ID_MEMBRESIA NUMBER CONSTRAINT FIDE_MEMBRESIAS_TB_ID_MEMBRESIA_PK PRIMARY KEY,
CEDULA NUMBER NOT NULL,
FECHA_INICIO DATE NOT NULL,
ID_ESTADO NUMBER NOT NULL,
FECHA_FIN DATE,
ID_TIPO_MEMBRESIA NUMBER NOT NULL,
CONSTRAINT FIDE_MEMBRESIAS_TB_CEDULA_FK FOREIGN KEY (CEDULA) REFERENCES FIDE_USUARIOS_TB(CEDULA),
CONSTRAINT FIDE_MEMBRESIAS_TB_TIPO_FK FOREIGN KEY (ID_TIPO_MEMBRESIA) REFERENCES FIDE_TIPO_MEMBRESIAS_TB (ID_TIPO_MEMBRESIA)) 
TABLESPACE FIDE_LOS_JAULES_TBS;
