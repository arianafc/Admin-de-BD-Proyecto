CREATE OR REPLACE PACKAGE FIDE_LOS_JAULES_USUARIOS_PKG AS
  ...
  -- Nuevo procedimiento para obtener usuario por cédula
  PROCEDURE FIDE_USUARIO_TB_GET_BY_CEDULA_SP (
...
CREATE OR REPLACE PACKAGE BODY FIDE_LOS_JAULES_USUARIOS_PKG AS
  ...
  -- Procedimiento que retorna un usuario específico por USUARIO
  PROCEDURE FIDE_USUARIO_TB_GET_BY_USUARIO_SP (
    p_usuario IN VARCHAR2,
    datos OUT SYS_REFCURSOR
  ) AS
  ...
  -- Nuevo procedimiento que retorna un usuario por CÉDULA
  PROCEDURE FIDE_USUARIO_TB_GET_BY_CEDULA_SP (
    p_cedula IN VARCHAR2,
    datos OUT SYS_REFCURSOR
  ) AS
  ...
  END FIDE_USUARIO_TB_GET_BY_CEDULA_SP;
